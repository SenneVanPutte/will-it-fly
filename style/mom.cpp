...
// ---------------------------------------------------------------------
//
// please also have a look at `mom.hpp` for a header example.
...
//
// Struct names: lower_case_with_underscores_s.
 ...
 */
class half_life_3_c : public valve_game_c
{
	...
	stupidity {1}
{
	...
	your_mom_c::sum_mom_masses += this->mass;
}


// Write empty constructors/destructors like this!
your_mom_c::~your_mom_c()
{
	//
}
